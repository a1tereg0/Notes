#pragma checksum "C:\Users\prasa\source\repos\NotesRestApi\Notes\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e50a064dddf6c36d8f8a59c6cb86cd8d0d37c468"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e50a064dddf6c36d8f8a59c6cb86cd8d0d37c468", @"/Pages/Index.cshtml")]
...
<script>
        ...
        if (allNotes === null) {
            fetch(""http://localhost:5000/api/Notes"")
                ...
                .then(data => {
                    ...
                    data.forEach(item => {
                        co");
            WriteLiteral(@"nst noteItem = document.createElement('li');
    ...
    notesListGroup.addEventListener('click', e => {
        ...
        let listItemElement = e.target.tagName === 'A' ?");
            WriteLiteral(@" e.target.parentElement : e.target;
    ...
    notesEditText.addEventListener('input', (e) => {
        ...
        timer = setTimeout(() => {
            ...
            ");
            WriteLiteral(@"    listItem.querySelector('a').text = currentNote.title;
    ...
    deleteButton.addEventListener('click', e => {
        ...
        if (noteId !== undefined) {
            ...
            no");
            WriteLiteral("teListItem.remove()\r\n            fetch(`http://localhost:5000/api/Notes/${noteId}`, {\r\n                method: \'DELETE\'\r\n            });\r\n        }\r\n    })\r\n\r\n    allNotesElement.click();\r\n</script>\r\n");
        }
